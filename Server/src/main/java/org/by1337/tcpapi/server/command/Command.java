package org.by1337.tcpapi.server.command;

import org.by1337.tcpapi.server.command.argument.Argument;
import org.by1337.tcpapi.server.command.argument.ArgumentMap;
import org.by1337.tcpapi.server.command.argument.ArgumentStrings;
import org.by1337.tcpapi.server.command.requires.Requires;
    ...
    public void process(T sender, String[] args) throws CommandException {
        ...
        for (String arg : args) {
            ...
            if (argumentIterator.hasNext()) {
                ...
                throw new CommandSyntaxError(String.format("There is no subcommand that accepts this many arguments: %s", arg));
            }
        }
