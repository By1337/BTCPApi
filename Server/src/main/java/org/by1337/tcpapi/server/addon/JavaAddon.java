    ...
    public void saveResource(@NotNull String resourcePath, boolean replace) {
        ...
        try {
            if (!outFile.exists() || replace) {
                ...
                logger.log(Level.WARNING, "Could not saveAndPrint " + outFile.getName() + " to " + outFile + " because " + outFile.getName() + " already exists.");
            }
        } catch (IOException ex) {
            logger.log(Level.SEVERE, "Could not saveAndPrint " + outFile.getName() + " to " + outFile, ex);
        }
    }
